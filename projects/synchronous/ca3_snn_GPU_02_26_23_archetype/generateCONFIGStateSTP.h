...
sim.connect(CA3_Basket, CA3_Basket, "random", RangeWeight(0.0f, 1.0f, 1.55f), 0.00663136909224044f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 2.139606233f, 0.0f);
                                       
sim.connect(CA3_Basket, CA3_MFA_ORDEN, "random", RangeWeight(0.0f, 1.0f, 1.75f), 0.00573675602167279f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 1.681117626f, 0.0f);
                                       
sim.connect(CA3_Basket, CA3_Pyramidal, "random", RangeWeight(0.0f, 1.0f, 2.45f), 0.15f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 1.104194742f, 0.0f);
                                       
sim.connect(CA3_MFA_ORDEN, CA3_Basket, "random", RangeWeight(0.0f, 1.0f, 1.55f), 0.0117345087001957f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 1.450174133f, 0.0f);
                                       
sim.connect(CA3_MFA_ORDEN, CA3_MFA_ORDEN, "random", RangeWeight(0.0f, 1.0f, 1.75f), 0.00913901938344389f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 1.828413006f, 0.0f);
                                       
sim.connect(CA3_MFA_ORDEN, CA3_Pyramidal, "random", RangeWeight(0.0f, 1.0f, 2.45f), 0.0637836805073049f,
                                          RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 0.858647029f, 0.0f);
                                   
sim.connect(CA3_Pyramidal, CA3_Basket, "random", RangeWeight(0.0f, 1.0f, 2.45f), 0.0161746579069214f,
                                      RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 0.910763922f, 0.0f);
                                  
sim.connect(CA3_Pyramidal, CA3_MFA_ORDEN, "random", RangeWeight(0.0f, 1.0f, 2.25f), 0.0176731417548347f,
                                      RangeDelay(1), RadiusRF(-1.0), SYN_PLASTIC, 1.039009039f, 0.0f);
                                   
sim.connect(CA3_Pyramidal, CA3_Pyramidal, "random", RangeWeight(0.0f, 1.0f, 1.55f), 0.0250664662231983f,
